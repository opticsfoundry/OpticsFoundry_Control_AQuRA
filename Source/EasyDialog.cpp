...
/*	if (ToolTip != nullptr)
  ...
  1. Install GFlags and Application Verifier from Windows SDK:
	 - Download "Windows SDK for Windows 10"
	 - During install, select "Debugging Tools for Windows"

  2. Enable PageHeap using GFlags:
	 - Run: gflags.exe
	 - Go to "Image File" tab
	 - Enter your .exe name (e.g. MyApp.exe)
	 - Click "Enable PageHeap" -> Select "Full"

  3. Configure Application Verifier:
	 - Run: appverif.exe
	 - Add your .exe
	 - Enable checks: Basics + Heaps + Handles + Locks (at minimum)

  4. Run your app under debugger:
	 - Use WinDbg or launch via Visual Studio
	 - Breaks will occur at the time of heap misuse

  Useful links:
	- https://learn.microsoft.com/en-us/windows-hardware/drivers/debugger/
	- https://learn.microsoft.com/en-us/windows-hardware/test/what-is-application-verifier

  Remove PageHeap/AppVerifier when done to avoid performance issues.
*/
}
