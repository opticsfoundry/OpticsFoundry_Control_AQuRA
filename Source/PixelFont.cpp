...
unsigned char PixelFontData[84*5] = {
...
PixelFont::PixelFont(const CString text)
{
	Length=text.GetLength()*6;
	Pixels=new unsigned char[Length];
	for (int i = 0;i<text.GetLength();i++) {
		unsigned int StartEntry=GetCharacterTableEntry(text[i])*5;
		for (int j=0;j<5;j++) {
			Pixels[i*6+j]=PixelFontData[StartEntry+j];
		}
		Pixels[i*6+5]=0;
	}
}

PixelFont::~PixelFont(void)
{
	if (Pixels) delete[] Pixels;
}

unsigned int PixelFont::GetCharacterTableEntry(unsigned char character) {
	if ((character>='A') && (character<='Z')) return character-'A';
	else if ((character>='a') && (character<='z')) return character-'a'+26;
	else if ((character>='0') && (character<='9')) return character-'0'+52;
	else if (character=='?') return 62;
	else if (character=='!') return 63;
	else if (character=='@') return 64;
	else if (character=='#') return 65;
	else if (character=='&') return 66;
	else if (character=='(') return 67;
	else if (character==')') return 68;
	else if (character=='+') return 69;
	else if (character=='-') return 70;
	else if (character=='=') return 71;
	else if (character=='>') return 72;
	else if (character=='<') return 73;
	else if (character=='$') return 74;
	else if (character=='€') return 75;
	else if (character=='*') return 77;
	else return 76;
}
