...
double* InitIntensityClockCavityDedriftDDS;
double* InitStartFrequencyClockCavityDedriftDDS;
double* InitStopFrequencyClockCavityDedriftDDS;
double* InitModulationFrequencyClockCavityDedriftDDS;
bool* InitFSKModeClockCavityDedriftDDS;
double* InitRampRateClockClockCavityDedriftDDS;
bool* InitClearACC1ClockCavityDedriftDDS;
bool* InitTriangleBitClockCavityDedriftDDS;
bool* InitFSKBitClockCavityDedriftDDS;
...
double* InitIntensityClockFNCOutputAlignmentDDS;
double* InitStartFrequencyClockFNCOutputAlignmentDDS;
double* InitStopFrequencyClockFNCOutputAlignmentDDS;
double* InitModulationFrequencyClockFNCOutputAlignmentDDS;
bool* InitFSKModeClockFNCOutputAlignmentDDS;
double* InitRampRateClockClockFNCOutputAlignmentDDS;
bool* InitClearACC1ClockFNCOutputAlignmentDDS;
bool* InitTriangleBitClockFNCOutputAlignmentDDS;
bool* InitFSKBitClockFNCOutputAlignmentDDS;
double* InitIntensityClockExtraFNCOutputAlignmentDDS;
double* InitStartFrequencyClockExtraFNCOutputAlignmentDDS;
double* InitStopFrequencyClockExtraFNCOutputAlignmentDDS;
double* InitModulationFrequencyClockExtraFNCOutputAlignmentDDS;
bool* InitFSKModeClockExtraFNCOutputAlignmentDDS;
double* InitRampRateClockClockExtraFNCOutputAlignmentDDS;
bool* InitClearACC1ClockExtraFNCOutputAlignmentDDS;
bool* InitTriangleBitClockExtraFNCOutputAlignmentDDS;
bool* InitFSKBitClockExtraFNCOutputAlignmentDDS;
...
double* InitFrequencySpareAD9858DDS;
double* InitIntensitySpareAD9858DDS;
double* InitFrequencyCh0LatticeEOM;
double* InitIntensityCh0LatticeEOM;
double* InitFrequencyCh1LatticeEOM;
double* InitIntensityCh1LatticeEOM;
double* InitPhaseCh1LatticeEOM;
...
void CParamRegister::CreateShortcutsToUserIOInitParams() {
	...
	InitBlueMasterShutter = GetParamBool("InitBlueMasterShutter");
	...
	InitIntensityClockCavityDedriftDDS = GetParamDouble("InitIntensityClockCavityDedriftDDS");
	InitStartFrequencyClockCavityDedriftDDS = GetParamDouble("InitStartFrequencyClockCavityDedriftDDS");
	InitStopFrequencyClockCavityDedriftDDS = GetParamDouble("InitStopFrequencyClockCavityDedriftDDS");
	InitModulationFrequencyClockCavityDedriftDDS = GetParamDouble("InitModulationFrequencyClockCavityDedriftDDS");
	InitFSKModeClockCavityDedriftDDS = GetParamBool("InitFSKModeClockCavityDedriftDDS");
	InitRampRateClockClockCavityDedriftDDS = GetParamDouble("InitRampRateClockClockCavityDedriftDDS");
	InitClearACC1ClockCavityDedriftDDS = GetParamBool("InitClearACC1ClockCavityDedriftDDS");
	InitTriangleBitClockCavityDedriftDDS = GetParamBool("InitTriangleBitClockCavityDedriftDDS");
	InitFSKBitClockCavityDedriftDDS = GetParamBool("InitFSKBitClockCavityDedriftDDS");
	...
	InitIntensityClockFNCOutputAlignmentDDS = GetParamDouble("InitIntensityClockFNCOutputAlignmentDDS");
	InitStartFrequencyClockFNCOutputAlignmentDDS = GetParamDouble("InitStartFrequencyClockFNCOutputAlignmentDDS");
	InitStopFrequencyClockFNCOutputAlignmentDDS = GetParamDouble("InitStopFrequencyClockFNCOutputAlignmentDDS");
	InitModulationFrequencyClockFNCOutputAlignmentDDS = GetParamDouble("InitModulationFrequencyClockFNCOutputAlignmentDDS");
	InitFSKModeClockFNCOutputAlignmentDDS = GetParamBool("InitFSKModeClockFNCOutputAlignmentDDS");
	InitRampRateClockClockFNCOutputAlignmentDDS = GetParamDouble("InitRampRateClockClockFNCOutputAlignmentDDS");
	InitClearACC1ClockFNCOutputAlignmentDDS = GetParamBool("InitClearACC1ClockFNCOutputAlignmentDDS");
	InitTriangleBitClockFNCOutputAlignmentDDS = GetParamBool("InitTriangleBitClockFNCOutputAlignmentDDS");
	InitFSKBitClockFNCOutputAlignmentDDS = GetParamBool("InitFSKBitClockFNCOutputAlignmentDDS");
	InitIntensityClockExtraFNCOutputAlignmentDDS = GetParamDouble("InitIntensityClockExtraFNCOutputAlignmentDDS");
	InitStartFrequencyClockExtraFNCOutputAlignmentDDS = GetParamDouble("InitStartFrequencyClockExtraFNCOutputAlignmentDDS");
	InitStopFrequencyClockExtraFNCOutputAlignmentDDS = GetParamDouble("InitStopFrequencyClockExtraFNCOutputAlignmentDDS");
	InitModulationFrequencyClockExtraFNCOutputAlignmentDDS = GetParamDouble("InitModulationFrequencyClockExtraFNCOutputAlignmentDDS");
	InitFSKModeClockExtraFNCOutputAlignmentDDS = GetParamBool("InitFSKModeClockExtraFNCOutputAlignmentDDS");
	InitRampRateClockClockExtraFNCOutputAlignmentDDS = GetParamDouble("InitRampRateClockClockExtraFNCOutputAlignmentDDS");
	InitClearACC1ClockExtraFNCOutputAlignmentDDS = GetParamBool("InitClearACC1ClockExtraFNCOutputAlignmentDDS");
	InitTriangleBitClockExtraFNCOutputAlignmentDDS = GetParamBool("InitTriangleBitClockExtraFNCOutputAlignmentDDS");
	InitFSKBitClockExtraFNCOutputAlignmentDDS = GetParamBool("InitFSKBitClockExtraFNCOutputAlignmentDDS");
	...
	InitFrequencySpareAD9858DDS = GetParamDouble("InitFrequencySpareAD9858DDS");
	InitIntensitySpareAD9858DDS = GetParamDouble("InitIntensitySpareAD9858DDS");
	InitFrequencyCh0LatticeEOM = GetParamDouble("InitFrequencyCh0LatticeEOM");
	InitIntensityCh0LatticeEOM = GetParamDouble("InitIntensityCh0LatticeEOM");
	InitFrequencyCh1LatticeEOM = GetParamDouble("InitFrequencyCh1LatticeEOM");
	InitIntensityCh1LatticeEOM = GetParamDouble("InitIntensityCh1LatticeEOM");
	InitPhaseCh1LatticeEOM = GetParamDouble("InitPhaseCh1LatticeEOM");
